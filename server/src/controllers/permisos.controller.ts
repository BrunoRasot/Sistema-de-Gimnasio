    ...
    try {
        ...
        const operaciones = Object.entries(permisos).map(([modulo, acciones]: any) => {
            return prisma.permiso.upsert({
                ...
                update: { ver: acciones.Ver, crear: acciones.Crear, editar: acciones.Editar, eliminar: acciones.Eliminar },
                create: { cargo, modulo, ver: acciones.Ver, crear: acciones.Crear, editar: acciones.Editar, eliminar: acciones.Eliminar }
            });
        });
